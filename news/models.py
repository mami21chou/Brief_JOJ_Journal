...
class Article(models.Model):
    ...
    contenu=models.CharField(verbose_name="contenu articles", max_length=50)
    image=models.ImageField(verbose_name="image", upload_to="articles_images", blank=True, null=True)
